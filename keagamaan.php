...
<div class="container-fluid">
  ...
  <div class="container-fluid">
    <div class="d-flex justify-content-center">
    <img src="<?php echo $a7;?>" alt="Foto" class="rounded img-fluid" style="width: 600px; height: 300px; object-fit: cover;">
    </div>    
  </div>
  
  <div class="container-fluid" style="width:95%">
    <h3 class="mt-4">Penjelasan Singkat</h3>
    <p>OSIM SEKSI BIDANG KEAGAMAAN yaitu suatu perkumpulan para siswa untuk melaksanakan sistem kerja dimana didalamnya  mengandung unsur keagamaan baik itu berupa sikap dan perbuatan yang mencerminkan kepada masyarakat disekitar sekolah, maupun kegiatan kegiatan yang membangun kesadaran masyarakat sekolah khususnya akan rasa taqwa dan peduli antar sesama.</p>
  </div>

  <div class="container-fluid mb-5" style="width:95%">
    <h3 class="mt-4">Fungsi</h3>
    <p>
    - Mewujudkan masyarakat sekolah yakni siswa-siswi yang berada di lingkungan sekolah yang beradab, berwawasan yang luas, dan memiliki ketaqwaan yang baik kepada Tuhan yang maha Esa
</p>
<p>
-Memperingati Hari-hari besar keagamaan, beserta perlombaan yang diadakan didalamnya. 
</p>
<p>
-Mendukung kegiatan ekstrakurikuler sekolah yang bernuansa kegamaan
</p>
<p>
-Mengembangkan dan meningkatkan kinerja SEKBID agama dalam melaksanakan sistem " Yang telah dirancang dan ingin dicapai.
</p>
  </div>
