...
<html lang="en">
  ...
  <div class="container-fluid" style="width: 1500px;">
    ...
    <div class="content" id="hero" style="background-image: url('<?php echo $gambarBg; ?>')">
    <div class="container">
            <div class="row">
              <div class="col-md-12 page-header">
                <div>
                <h1>OSIM MAS MUALLIMIN UNIVA MEDAN</h1>
                <h1>BE SMART WITH AL-QUR'AN, BERSAMA BISA JAYA</h1>
                <div class="kenalan">
                <button onclick="location.href='#tentang-kami'"><h4>Kenalan Yuk</h4></button>
            </div>  
               </div>
...
<div class="judul judul-ok">
        ...
        <div class="kenalan" style="margin-top:20px;">
              <button><h4>Form Aspirasi</h4></button>
            </div>  
      </div>
...
<div class="judul judul-ok">
  ...
  <img class="card-img-top" src="<?php echo $a11 ?>" alt="Card image cap" style="width: 500px; height: auto;">
  <div class="card-body">
    <h5 class="card-title">Sertijab (Serah Terima Jabatan) Osim Mas Muallimin periode 2023/2024 kepada Osim Mas Muallimin periode 2024/2025.</h5>
    <p class="card-text">Pada hari ini Senin 22 Januari 2024 Mas Muallimin Univa Medan melaksanakan Sertijab ( serah terima jabatan ) yang dilaksanakan pada pagi hari setelah upacara selesai, kegiatan ini dilaksanakan bertujuan untuk menyerahkan kepemimpinan, tanggung jawab, dan wewenang dari pengurus dan Ketua Osim Mas Muallimin Univa periode 2023/2024 kepada pengurus dan Ketua Osim Mas Muallimin Univa periode 2024/2025 hal ini ditujukan dengan penuh harapan agar Osim Mas Muallimin setelah dilantik nya anggota, pengurus, dan ketua Osim yang baru dapat memberikan inovasi dan ide ide baru, bertanggung jawab terhadap amanah yang diberikan, menjadi pemimpin yang cerdas dan jujur, serta dapat menjadikan Mas Muallimin Univa Medan yang lebih baik lagi kedepannya, dan menjadi organisasi yang berperan penting bagi kemajuan Madrasah Aliyah Muallimin Univa Medan kita yang tercinta ini.</p>
    <div class="d-flex justify-content-center">
