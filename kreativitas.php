...
<div class="container-fluid">
    <div class="d-flex justify-content-center">
        <h4 class="mt-5">Bidang Kreativitas</h4>
    </div>
</div>
  <div class="container-fluid">
    <div class="d-flex justify-content-center">
    <img src="<?php echo $a9;?>" alt="Foto" class="rounded img-fluid" style="width: 600px; height: 300px; object-fit: cover;">
    </div>    
  </div>
  
  <div class="container-fluid" style="width:95%">
    <h3 class="mt-4">Penjelasan Singkat</h3>
    <p>Sekbid kreativitas merupakan sekbid yang menjadi  wadah dalam menyalurkan ide kreatif dan inspiratif dan menjadi garda terdepan bagi para siswa siswi dalam mewujudkan bakat kreativitas mereka.</p>  </div>

  <div class="container-fluid mb-5" style="width:95%">
    <h3 class="mt-4">Fungsi</h3>

<p>
Sekbid kreativitas juga bertugas untuk meningkat kan kemampuan siswa dalam menciptakan dan menghasilkan barang dan jasa yang berguna, dan adapun juga sekbid kreativitas berfungsi dalam memberikan informasi terkini kepada siswa siswi MAS muallimin melalui Mading,baik event perlombaan, poster hari hari besar dll. Mewujudkan siswa siswi yang ber kreatif , inovatif dan inspiratif agar terwujud nya anak muda yg aktif penuh kreatif.
</p>
