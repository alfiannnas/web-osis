...
<div class="container-fluid">
  ...
  <div class="container-fluid">
    <div class="d-flex justify-content-center">
    <img src="<?php echo $a10;?>" alt="Foto" class="rounded img-fluid" style="width: 600px; height: 300px; object-fit: cover;">
    </div>    
  </div>
  
  <div class="container-fluid" style="width:95%">
    <h3 class="mt-4">Penjelasan Singkat</h3>
    <p>Leadership di ambil dari Bahasa Inggris yang artinya kepemimpinan, Leadership juga sebagai contoh pemimpin bagi siswa/i Mas Muallimin dan mengajak siswa/i Mas Muallimin menjadi pemimpin di masa depan.</p>  </div>

  <div class="container-fluid mb-5" style="width:95%">
    <h3 class="mt-4">Fungsi</h3>

<p>
1. Mengajar/melatih upacara.
</p>
<p>
2. Mengatur semua keamanan.
</p>
<p>
3.Menjadi sekbid yang lebih disiplin dari sekbid lain nya
</p>
<p>
4. Membangun kolaborasi, komunikasi, dan koordinasi yang baik.
</p>
<p>
5. Menjadi ajudan para guru, kepala sekolah, maupun struktur yang ada di Mas Muallimin pada saat mengadakan acara.
</p>
<p>
6. Menaiki dan menuruni bendera setiap hari.
</p>
